/**
 * Clean ad-free Vidmoly embed page template.
 * Resolves HLS via /api/resolve-vidmoly-stream and plays via hls.js.
 */

export function buildVidmolyEmbedHtml(videoId, startTime, vidmolyUrl) {
  return `<!DOCTYPE html>
<html><head>
