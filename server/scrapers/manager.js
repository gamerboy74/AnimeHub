...
export async function scrapeAndSaveEpisode(anime, ep) {
  ...
  try {
    ...
    if (isNotFoundCached) {
      ...
      console.log(`    [1/5] NineAnime checking EP ${ep}...`);
  ...
  try {
    console.log(`    [2/5] AnimeSuge checking EP ${ep}...`);
  ...
  let reAnimeRes = null;
  try {
    console.log(`    [3/5] Re:ANIME checking EP ${ep}...`);
  ...
  try {
    console.log(`    [4/5] SanjiAnime checking EP ${ep}...`);
  ...
  let cinevoRes = null;
  try {
    console.log(`    [5/5] Cinevo checking EP ${ep}...`);
