...
export interface AnimeSugeScrapeResult {
  success: boolean;
  watchUrl?: string;
  streamUrl?: string;
  episodeData?: {
...
export class AnimeSugeScraperService {
  ...
  static async batchScrapeEpisodes(
    ...
    try {
      ...
      const results: AnimeSugeScrapeResult[] = [];
      let successCount = 0;
      let errorCount = 0;
